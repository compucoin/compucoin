...
- A proper fork of the Litecoin project on Github was made, incorporating all the changes that were in 1.1.3.0:
  - compucoin specific branding
  - compucoin specific block time, size, ...
...
- Following has been changed in comparison to the source of 1.1.3.0:
  ...
  - Changed references to "compucoin Wiki" to compucoin website
  ...
  - Renamed litecoin.icns to compucoin.icns according to config file
